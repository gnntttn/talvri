...
export const HeroSlider: React.FC<HeroSliderProps> = ({ movies, onSelectMovie }) => {
  ...
  const backdropUrl = currentMovie.backdrop_path
    ? `${TMDB_IMAGE_BASE_URL}/w1280${currentMovie.backdrop_path}`
    : undefined;
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-4 sm:p-8 md:p-12 w-full sm:w-3/4 md:w-1/2">
            ...
            <div className="flex items-center gap-4 mb-4 sm:mb-6">
                <div className="flex items-center">
                    ...
                    <span className="text-white ml-1 rtl:mr-1 rtl:ml-0 font-semibold">{(currentMovie.vote_average || 0).toFixed(1)} / 10</span>
                </div>
            </div>
            <div className="flex">
                <button
