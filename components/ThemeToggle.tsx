...
export const ThemeToggle: React.FC<ThemeToggleProps> = ({ theme, setTheme }) => {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="relative z-10 p-2 rounded-full text-slate-500 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-slate-900 transition-colors duration-200"
