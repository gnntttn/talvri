...
const translations = {
  en: {
    ...
    askAnythingAbout: 'Ask anything about {title}...',
    ask: 'Ask',
    geminiIsThinking: 'Gemini is thinking...',
    suggestionExplainEnding: 'Explain the ending (no spoilers)',
    suggestionIsItForKids: 'Is it suitable for kids?',
    suggestionMainTheme: 'What is the main theme?',
    geminiDisclaimer: 'Responses are generated by AI and may be inaccurate.',
  },
  ar: {
    appName: 'Talvri',
    ...
    pause: 'إيقاف مؤقت',
    // Ask Gemini Feature
    askGemini: 'اسأل Gemini',
    askAnythingAbout: 'اسأل أي شيء عن {title}...',
    ask: 'اسأل',
    geminiIsThinking: '...Gemini يفكر',
    suggestionExplainEnding: 'اشرح النهاية (بدون حرق)',
    suggestionIsItForKids: 'هل هو مناسب للأطفال؟',
    suggestionMainTheme: 'ما هي الفكرة الرئيسية؟',
    geminiDisclaimer: 'الإجابات مُنشأة بواسطة الذكاء الاصطناعي وقد تكون غير دقيقة.',
  }
};
